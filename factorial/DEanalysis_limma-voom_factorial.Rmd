...
se.filt <- readRDS(file.path("results", "se.factorial.filt.rds"))
dge.filt <- readRDS(file.path("results", "dge.factorial.filt.rds"))
```
...
colnames(mod) <- c(colnames(mod)[1:(nlevels(se.filt$tobacco_smoking_history_indicator))], paste0("SV", 1:sv$n))

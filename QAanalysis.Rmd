...
Here we generate the MA-plot using type sample as grouping fator. 
...
We will keep only genes that have this minimum level of expresseion in at least as many samples as the smallest group of comparison. We are still comparing sample type. 
